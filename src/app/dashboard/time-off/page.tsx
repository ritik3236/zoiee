  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 text-left">
      ...
      <div className="space-y-4">
        <h2 className="text-sm font-bold text-neutral-500 uppercase tracking-widest mt-8">Pending Roster Swaps</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="bg-white p-5 rounded-3xl border border-neutral-200 shadow-sm flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-2xl bg-neutral-50 text-neutral-900 flex items-center justify-center border border-neutral-200 shadow-sm">
              ...
              <div className="flex gap-2">
                <button className="p-2.5 rounded-full border border-neutral-200 text-neutral-500 hover:text-red-650 hover:bg-red-50 hover:border-red-200 transition-colors cursor-pointer">
                  <X className="w-5 h-5 text-neutral-900" />
                </button>
                <button className="p-2.5 rounded-full bg-black text-white hover:bg-neutral-900 transition-colors cursor-pointer">
